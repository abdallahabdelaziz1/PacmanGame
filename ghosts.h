...
public:
    ...
    virtual void FollowPaceman(QPair<int, int> PacmanCoordiante); //function that determines the moves of the ghost. Now, random. Will be overrided in the next milestone
